...
export default function VaporizeTextCycle({
  ...
  }, [texts, font, color, alignment, textOffset, wrapperSize, currentTextIndex, globalDpr, transformedDensity]);
...
const renderCanvas = ({
  ...
  // Add padding offset to avoid edge clipping during animation
  const paddingOffset = framerProps.textOffset ?? 30;
  ...
  if (framerProps.alignment === "center") {
    ...
    textX = canvas.width - paddingOffset;
  }
  ...
  particles.forEach(particle => {
    ...
    if (shouldVaporize) {
      ...
      if (particle.shouldFadeQuickly) {
        ...
        const currentVelocity = Math.sqrt(particle.velocityX * particle.velocityY * particle.velocityY);
