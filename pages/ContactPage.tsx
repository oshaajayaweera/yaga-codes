    ...
    return (
        <main className="min-h-screen w-full bg-background pt-32 px-6 md:px-20 pb-32">
            ...
            <div className="max-w-6xl mx-auto mb-12">
                 <div className="h-[140px] w-full flex justify-center items-center overflow-visible">
                    <VaporizeTextCycle
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="flex flex-col space-y-8">
                     <div>
                         <p className="text-muted-foreground text-lg md:text-xl leading-relaxed max-w-md text-center lg:text-left mx-auto lg:mx-0">
                     ...
                     <div className="pt-4 text-center lg:text-left">
                        ...
                        <div className="flex gap-4 flex-wrap justify-center lg:justify-start">
                            {[
                                ...
                                >
                                  <Button variant="outline" size="icon" className="rounded-full h-12 w-12 border-border bg-background/5 hover:bg-foreground hover:text-background text-foreground transition-all duration-300">
                                      {/* @ts-ignore */}
